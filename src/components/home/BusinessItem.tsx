...
function BusinessItem({
  ...
  return (
    <div
      className="w-[180px] flex-shrink-0 p-2
     rounded-lg shadow-md mb-1
     bg-white hover:scale-110 transition-all mt-[20px] cursor-pointer select-none"
    >
      <Image
        priority
        src={`https://maps.googleapis.com/maps/api/place/photo?maxwidth=180&photoreference=${photo_ref}&key=${GOOGLE_API_KEY}`}
        alt={business.name}
        width={160}
        height={80}
